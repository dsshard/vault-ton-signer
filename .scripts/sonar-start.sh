...
sonar-scanner -D sonar.projectKey="vault-ton-signer" \
              -D sonar.projectName="vault-ton-signer" \
              ...
              -D sonar.github.repository='https://github.com/dsshard/vault-ton-signer' \
              -D sonar.token="${token}"
